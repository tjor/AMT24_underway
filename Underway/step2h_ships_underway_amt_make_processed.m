...
#      fflush(stdout);
      ...
      tmp1 = FNC_GPS([din_gps{1}]); # modified for AMT 24 (due to GPS files being named differently)
      tmp2 = FNC_METDATA([din_met{1}]);# modified for AMT 24 (due to to met files being named differently)
